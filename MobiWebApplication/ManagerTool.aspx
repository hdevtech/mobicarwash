                     ...
                     <td>
                         <table class="auto-style4">
                             <tr>
                                 ...
                                 <td>
                                     <asp:Button ID="Button84" runat="server" BackColor="SandyBrown" BorderStyle="None" CssClass="auto-style209" Font-Bold="False" Font-Names="Agency FB" Font-Size="Large" ForeColor="Navy" Height="40px" OnClick="Button84_Click" onmouseout="this.style.backgroundColor='SandyBrown'" onmouseover="this.style.backgroundColor='DarkSlateGray'" Text="Stock Request " Width="100%" />
                                 </td>
                                 <td>
