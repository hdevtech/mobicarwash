<%@ Page Title="" Language="C#" MasterPageFile="~/BarRestoOperator.Master" AutoEventWireup="true" CodeBehind="ServiceAll.aspx.cs" Inherits="MobiWebApplication.WebForm3" %>
                        ...
                        <table >
                                                                                    ...
                                                                                    <table class="auto-style45">
                                                                                                                                    ...
                                                                                                                                    <table class="auto-style4">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td style="text-align: left">
                                                                                                                                                ...
                                                                                                                                                <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [IDPayment], [Payment] FROM [PaymentType]">
                                                                                                                                                </asp:SqlDataSource>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td style="text-align: left">
                                                                                                                                                <asp:Panel ID="Panel15" runat="server" BackColor="#006666" CssClass="Panel1Registration">
                                                                                                                                                    ...
                                                                                                                                                    <asp:SqlDataSource ID="NameSev" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT IdService, NameService, IdManufacture FROM ServiceDerivery WHERE (IdManufacture = @IdManufacture)">
                                                                                                                                                        <SelectParameters>
                                                                                                                                                                ...
                                                                                                                                                                <table class="auto-style4">
                                                                                                                                                                    <tr>
                                                                                                                                                                        <td align="left" style="text-align: left">
                                                                                                                                                                            <asp:DropDownList ID="DropDownList26" runat="server" AutoPostBack="True" BackColor="#006666" CssClass="BUTTOM" ForeColor="White" Visible="False" DataSourceID="NameSev" DataTextField="NameService" DataValueField="IdService">
                                                                                                                                                                            </asp:DropDownList>
                                                                                                                                                                        </td>
                                                                                                                                                                        <td style="text-align: left">
                                                                                                                                        ...
                                                                                                                                        <table class="auto-style45">
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style238">
                                                                                                                                                    <asp:Label ID="Label43" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Plate No:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="PlateNumberLabel" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("PlateNumber") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style412">
                                                                                                                                                    <asp:Label ID="Label44" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Vehicle:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="brandLabel" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("brand") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style238">
                                                                                                                                                    <asp:Label ID="Label45" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Category:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="manufactureNameLabel" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("manufactureName") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style235">
                                                                                                                                                    <asp:Label ID="Label46" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Client:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="NameLabel" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("Name") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style238">
                                                                                                                                                    <asp:Label ID="Label47" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Contact No:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="PhoneLabel" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("Phone") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style238">
                                                                                                                                                    <asp:Label ID="Label48" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Service:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="NameServiceLabel" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("NameService") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style238">
                                                                                                                                                    <asp:Label ID="Label49" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Staff:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="Washer" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("StaffName") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style238">
                                                                                                                                                    <asp:Label ID="Label50" runat="server" Font-Names="Agency FB" Font-Size="Medium" Text="Date:" Font-Bold="False"></asp:Label>
                                                                                                                                                    <asp:Label ID="dateRecordedLabel" runat="server" DataFormatString="{0:d/MM/yyyy}" Font-Names="Agency FB" Font-Size="Medium" Text='<%# Bind("dateRecorded","{0:d/MM/yyyy}") %>' Font-Bold="False" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="auto-style228" colspan="2">
                                                                                                <asp:Button ID="Button51" runat="server" BackColor="SandyBrown" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="Navy" Height="39px" OnClick="Button51_Click" onmouseout="this.style.backgroundColor='SandyBrown'" onmouseover="this.style.backgroundColor='Orange'" Text="Served Vehicle" Width="203px" />
                                                                                            </td>
                                                                                            <td class="auto-style228" style="text-align: left" colspan="2">
                                                                                                <asp:Button ID="Button30" runat="server" BackColor="SandyBrown" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="Navy" Height="39px" OnClick="Button30_Click" onmouseout="this.style.backgroundColor='SandyBrown'" onmouseover="this.style.backgroundColor='Orange'" Text="New Vehicle" Width="203px" />
                                                                                            </td>
                                                                                            <td class="auto-style233" style="text-align: right">
                                                                                                <asp:Button ID="Button69" runat="server" BackColor="SandyBrown" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="Navy" Height="39px" OnClientClick="doPrintInoice()" onmouseout="this.style.backgroundColor='SandyBrown'" onmouseover="this.style.backgroundColor='Orange'" Text="Print" Width="135px" OnClick="Button69_Click" />
                                                                                            </td>
                                                                                            <td class="auto-style233" style="text-align: right">
                                                                                                &nbsp;</td>
                                                                                            <td class="auto-style233" style="text-align: right">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Label ID="ClientName" runat="server" Text="ClientName" Visible="False"></asp:Label>
                                    <asp:Label ID="idCategory" runat="server" Text="idCategory" Visible="False"></asp:Label>
                                    <asp:Label ID="NameOfSevice" runat="server" Text="NameOfSevice" Visible="False"></asp:Label>
                                    <asp:Label ID="PaymenName" runat="server" Text="PaymenName" Visible="False"></asp:Label>
