        ...
        <tr>
            ...
            <td class="auto-style147" colspan="2">
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                    ...
                    Width="184px" DataSourceID="SqlDataSource1" DataTextField="OperationDay" DataValueField="OperationDay" Visible="False">
                </asp:DropDownList>
                </td>
            ...
            <td class="auto-style146">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [OperationDay], [idSales] FROM [StartDaily] ORDER BY [idSales] DESC" OnSelecting="SqlDataSource1_Selecting"></asp:SqlDataSource>
                </td>
        </tr>
        <tr>
                    ...
                    <table class="auto-style122">
                        <tr>
                            ...
                            <td class="auto-style153">
                                <table class="auto-style122">
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td rowspan="2" style="text-align: center ;font-size: x-large; font-family:'Times New Roman'; color:orange; font-weight: 700;">STAFF CREDIT STATUS</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style128">
                                <asp:GridView ID="gvInformation" runat="server" AutoGenerateColumns="False" CellPadding="8" DataSourceID="SqlDataSource2" EnableModelValidation="True" ForeColor="#333333" GridLines="None" Height="56px" OnRowDataBound="gvInformation_RowDataBound" OnSelectedIndexChanged="gvInformation_SelectedIndexChanged" ShowFooter="True" style="margin-left: 0px" Width="737px">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [StaffName], [phone], [TotalCredit], [status] FROM [MGridViewCreditControlStaff2] ORDER BY [TotalCredit] DESC"></asp:SqlDataSource>
                            </td>
