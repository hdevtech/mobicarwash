...
<%@ Page Title="" Language="C#" MasterPageFile="~/BarRestoOperator.Master" AutoEventWireup="true" CodeBehind="ReportsMenu.aspx.cs" Inherits="MobiWebApplication.WebForm4" %>
                ...
                <asp:Panel ID="Panel2" runat="server" BackColor="#006666"  Width="887px">
                    <table >
                        <tr>
                            <td colspan="3">
                                <br />
                                <asp:Panel ID="Panel12" runat="server" CssClass="Panel1Registration" BackColor="Silver" Width="875px">
                                    <table>
                                        <tr>
                                            <td >
                                                <asp:Panel ID="Panel77" runat="server" BackColor="#006666" CssClass="Panel1Registration">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td valign="top" >
                                                                <asp:DropDownList ID="DropDownList14" runat="server" AutoPostBack="True" BackColor="Gray" CssClass="BUTTOM" DataSourceID="SqlDataSource2" DataTextField="OperationDay" DataValueField="OperationDay" ForeColor="White" OnSelectedIndexChanged="DropDownList14_SelectedIndexChanged" Font-Size="Large">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table >
                                                        <tr>
                                                            <td align="center" class="auto-style412" >
                                                                <asp:TextBox ID="TextBox9" runat="server" BorderColor="#003366" BorderStyle="Groove" CssClass="inputSearch" Height="41px" placeholder="      Search ...  " OnTextChanged="TextBox9_TextChanged" Width="123px"></asp:TextBox>
                                                            </td>
                                                            <td align="center" >
                                                            ...
                                                            <td>
                                                                <asp:Button ID="Button57" runat="server" BackColor="Orange" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="Navy" Height="46px"  onmouseout="this.style.backgroundColor='Orange'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="Print D" Width="78px" OnClick="Button57_Click" OnClientClick="doPrintdailyRPT()" />
                                                            </td>
                                                            <td class="auto-style13">
                                                                <asp:Button ID="Button58" runat="server" BackColor="Orange" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="Navy" Height="46px"  OnClientClick="   doPrintdailyShortRPT()" onmouseout="this.style.backgroundColor='Orange'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="Print S" Width="102px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="auto-style412"><b style="text-align: center"><span style="color: #000099">
                                                                <asp:DropDownList ID="DropDownListD3" runat="server" AutoPostBack="True" CssClass="txtsearch1" Visible="False">
                                                                </asp:DropDownList>
                                                                </span></b></td>
                                                            <td><b style="text-align: center"><span style="color: #000099">
                                                                <asp:DropDownList ID="DropDownListM3" runat="server" AutoPostBack="True" CssClass="txtsearch1" Visible="False">
                                                                </asp:DropDownList>
                                                                </span></b></td>
                                                            <td><b style="text-align: center"><span style="color: #000099">
                                                                <asp:DropDownList ID="DropDownListYEAR3" runat="server" AutoPostBack="True" CssClass="txtsearch1" Visible="False">
                                                                </asp:DropDownList>
                                                                </span></b></td>
                                                            <td class="auto-style13"><b style="text-align: center"><span style="color: #000099">
                                                                <asp:DropDownList ID="DropDownListD4" runat="server" AutoPostBack="True" CssClass="txtsearch1" Visible="False">
                                                                </asp:DropDownList>
                                                                </span></b></td>
                                                            <td class="auto-style13"><b style="text-align: center"><span style="color: #000099">
                                                                <asp:DropDownList ID="DropDownListM4" runat="server" AutoPostBack="True" CssClass="txtsearch1" Visible="False">
                                                                </asp:DropDownList>
                                                                </span></b></td>
                                                        </tr>
                                                    </table>
                        ...
                        <tr>
                            <td class="auto-style303" colspan="3">
                        ...
                        <tr>
                            <td  colspan="3">
                                <asp:Panel ID="Panel48" runat="server" BackColor="#006666" CssClass="PanelHomeLogin" Width="910px" BorderColor="#006666" BorderStyle="Solid" BorderWidth="2px">
                                    <table class="auto-style213">
                                        <tr>
                                            <td>
                                                <b style="text-align: center"><span style="color: #000099">
                                                <asp:DropDownList ID="DropDownList20" runat="server" AutoPostBack="True" BackColor="#006666" CssClass="BUTTOM" DataSourceID="MonthlyReports" DataTextField="operationMonth" DataValueField="operationMonth" ForeColor="#006666" Height="1px" Width="1px">
                                                </asp:DropDownList>
                                                </span></b></td>
                                        </tr>
                                        <tr>
                                            <td class="auto-style410">
                                                <asp:Panel ID="Panel3" runat="server" BackColor="#006666" CssClass="PanelHomeLogin" Width="904px" BorderColor="#006666" BorderStyle="None" BorderWidth="2px">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="Button2" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button2_Click2" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="STAFF CREDIT STATUS&gt;&gt;&gt;" Width="293px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button3" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button3_Click1" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="ADD SYSTEM USER" Width="305px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button6" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button6_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="ADD NEW STAFF" Width="294px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="Button33" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button33_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="CLIENTS COMMUNICATION&gt;&gt;" Width="293px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button35" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button35_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="CLIENT CREDITS STATUS&gt;&gt;&gt;" Width="305px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button37" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button37_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="CHANGE PRICE" Width="294px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="Button34" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button34_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="DELETE SERVICE" Width="293px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button36" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button36_Click1" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="CW SERVICES" Width="305px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button38" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button38_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="MONTHLY REPORTS &gt;&gt;&gt;" Width="294px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="Button61" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button61_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="STAFF CREDIT HISTORIC &gt;&gt;&gt;" Width="293px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button62" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button62_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="CREATE INVOICE &gt;&gt;&gt;" Width="305px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button63" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button63_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="CLIENT PAYMENT HISTORIC &gt;&gt;&gt;" Width="294px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td class="style43">
                                                                <asp:Button ID="Button72" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button72_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="LOAD STORE" Width="293px" />
                                                            </td>
                                                            <td class="style43">
                                                                <asp:Button ID="Button73" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button73_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="STORE" Width="305px" />
                                                            </td>
                                                            <td class="style43">
                                                                <asp:Button ID="Button74" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button74_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="STOCK HISTORIC" Width="294px" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="Button84" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="PURCHASE" Width="293px" OnClick="Button84_Click" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button82" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button82_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="KITCHEN" Width="305px" />
                                                            </td>
                                                            <td>
                                                                <asp:Button ID="Button83" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="MANAGER " Width="294px" OnClick="Button83_Click" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="auto-style411">
                                                                <asp:Button ID="Button85" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button85_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="SALES REPORT" Width="293px" />
                                                            </td>
                                                            <td class="auto-style411">
                                                                <asp:Button ID="Button87" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button87_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Text="BILLARD" Width="305px" />
                                                            </td>
                                                            <td class="auto-style411">
                                                                <asp:Button ID="Button88" runat="server" BackColor="Gray" BorderStyle="None" CssClass="auto-style209" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Height="50px" OnClick="Button88_Click" onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='#4CAF50'" Width="294px" Text="MONTHLY UNPAID" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
                                        ...
                                        <tr>
                                            <td><b style="text-align: center"><span style="color: #000099">
                                                <asp:DropDownList ID="DropDownListYEAR4" runat="server" AutoPostBack="True" CssClass="txtsearch1" Visible="False">
                                                </asp:DropDownList>
                                                </span></b></td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <table class="auto-style339">
                                                        <tr>
                                                            <td align="center"><b style="text-align: center"><span style="color: #000099">
                                                                <asp:Label ID="AlertLabel68" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White">Main Store </asp:Label>
                                                                <asp:GridView ID="GridClientPayment7" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SalesPurchaseHistoric4" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="#333333" GridLines="None" PageSize="5" Width="100%">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="PurchaseQuantity" HeaderText="Purchases" SortExpression="PurchaseQuantity">
                                                                        <HeaderStyle Font-Bold="False" />
                                                                        <ItemStyle Font-Bold="False" HorizontalAlign="Center" />
                                                                        </asp:BoundField>
                                                        ...
                                                        <tr>
                                                            <td align="center"><b style="text-align: center"><span style="color: #000099">
                                                                ...
                                                                <asp:SqlDataSource ID="SalesPurchaseHistoric3" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT idRecordHis, productName, idProduct, OldQuantity,MainStore, PurchaseQuantity, SalesQuantity, RemainQuantity, dateRecorded, OperationDay, operationMonth, operationYear, userAdded, recordStatuss FROM BarSalesPurchaseHistoricView WHERE (idProduct = @idProduct)    ORDER BY idRecordHis DESC">
                                                                    <SelectParameters>
                                                                        <asp:ControlParameter ControlID="Label7" Name="idProduct" PropertyName="Text" />
                                                                    </SelectParameters>
                                                                </asp:SqlDataSource>
                                                                <span style="color: #000099">
                                                                <asp:SqlDataSource ID="SalesPurchaseHistoric4" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT idRecordHis, productName, idProduct, OldQuantity, PurchaseQuantity, SalesQuantity, RemainQuantity, dateRecorded, OperationDay, operationMonth, operationYear, userAdded, recordStatuss FROM BarSalesPurchaseHistoricView2 WHERE (idProduct = @idProduct)    ORDER BY idRecordHis DESC">
                                                                    <SelectParameters>
                                                                        <asp:ControlParameter ControlID="Label7" Name="idProduct" PropertyName="Text" />
                                                                    </SelectParameters>
                                                                </asp:SqlDataSource>
                                                                <asp:Label ID="AlertLabel69" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White">Sub-Store </asp:Label>
                                                                <asp:GridView ID="GridClientPayment5" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SalesPurchaseHistoric3" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="#333333" GridLines="None" PageSize="5" Width="100%">
                                                                    <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                    <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                    <PagerStyle BackColor="Orange" Font-Size="XX-Large" ForeColor="Navy" HorizontalAlign="Center" />
                                                                    <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                ...
                                                                <asp:Label ID="AlertLabel70" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White">Sales </asp:Label>
                                                                <span style="color: #000099">
                                                                <asp:GridView ID="GridClientPayment8" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="Historic" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="Black" GridLines="None" PageSize="5" Width="100%">
                                                                    <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                    <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                    <PagerStyle BackColor="Orange" Font-Size="XX-Large" ForeColor="Navy" HorizontalAlign="Center" />
                                                                    <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                        ...
                                                        <tr>
                                                            <td align="center"><b style="text-align: center">
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                ...
                                                                <asp:Label ID="AlertLabel72" runat="server" CssClass="LABELINCREASE" Font-Bold="False" Font-Names="Tahoma" ForeColor="Orange">BAR</asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:GridView ID="gvInformation19" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#333333" BorderStyle="None" BorderWidth="0px" CellPadding="4" DataKeyNames="idProduct" DataSourceID="ProductsSkol0" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" GridLines="None" ShowHeader="False" style="margin-left: 0px" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:CheckBox ID="CheckBox75" runat="server" BackColor="DarkSlateGray" CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="Button95" runat="server" BackColor="#244242" BorderStyle="None" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Orange" Height="40px" OnClick="Button95_Click" onmouseout="this.style.backgroundColor='#244242'" onmouseover="this.style.backgroundColor='#CCCCCC'" Text="Historic" Width="100px" />
                                                                            </ItemTemplate>
                                                                            <HeaderStyle ForeColor="Navy" />
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <asp:GridView ID="gvInformation16" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#333333" BorderStyle="None" BorderWidth="0px" CellPadding="4" DataKeyNames="idProduct" DataSourceID="ProductsSkol1" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="None" ShowHeader="False" style="margin-left: 0px" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="Button96" runat="server" BackColor="#244242" BorderStyle="None" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Orange" Height="40px" OnClick="Button96_Click" onmouseout="this.style.backgroundColor='#244242'" onmouseover="this.style.backgroundColor='#CCCCCC'" Text="Historic" Width="100px" />
                                                                            </ItemTemplate>
                                                                            <HeaderStyle ForeColor="Navy" />
                                                                            <ItemStyle CssClass="input" Font-Bold="False" HorizontalAlign="Right" />
                                                                        </asp:TemplateField>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <asp:Label ID="AlertLabel76" runat="server" CssClass="LABELINCREASE" Font-Bold="False" Font-Names="Tahoma" ForeColor="Orange">KITCHEN</asp:Label>
                                                                <asp:SqlDataSource ID="ProductsBralirwa5" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [idProduct], [productName] ,quantityStock, PriceSales,PricePurchase,idDrinkCategory FROM [BarProducts] WHERE ([idDrinkCategory] = @idDrinkCategory) Order by [productName]">
                                                                    <SelectParameters>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <asp:GridView ID="gvInformation20" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#333333" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataKeyNames="idProduct" DataSourceID="ProductsBralirwa5" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="None" ShowHeader="False" style="margin-left: 0px" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:CheckBox ID="CheckBox76" runat="server" BackColor="DarkSlateGray" CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                            </ItemTemplate>
                                                                            <HeaderStyle ForeColor="Navy" />
                                                                            <ItemStyle CssClass="input" HorizontalAlign="Left" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="Button97" runat="server" BackColor="#244242" BorderStyle="None" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Orange" Height="40px" OnClick="Button97_Click" onmouseout="this.style.backgroundColor='#244242'" onmouseover="this.style.backgroundColor='#CCCCCC'" Text="Historic" Width="100px" />
                                                                            </ItemTemplate>
                                                                            <HeaderStyle ForeColor="Navy" />
                                                                            <ItemStyle CssClass="input" Font-Bold="False" HorizontalAlign="Right" />
                                                                        </asp:TemplateField>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <asp:Label ID="AlertLabel75" runat="server" CssClass="LABELINCREASE" Font-Bold="False" Font-Names="Tahoma" ForeColor="Orange">OTHERS</asp:Label>
                                                                <asp:SqlDataSource ID="ProductsBralirwa4" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [idProduct], [productName] ,quantityStock, PriceSales,PricePurchase,idDrinkCategory FROM [BarProducts] WHERE ([idDrinkCategory] = @idDrinkCategory) Order by [productName]">
                                                                    <SelectParameters>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Panel ID="Panel16" runat="server" BackColor="#006666" CssClass="PanelHomeLogin" Width="904px" BorderColor="#006666" BorderStyle="Solid" BorderWidth="2px">
                                                    <table class="auto-style213">
                                                        <tr>
                                                            <td align="center">
                                                                <asp:Label ID="AlertLabel40" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">DAILY SHORT REPORT ON:</asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                                <asp:FormView ID="FormView21" runat="server" DataFormatString="{0:d/MM/yyyy}" DataSourceID="SqlDataSourceDATE" EnableModelValidation="True" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White">
                                                                    <EditItemTemplate>
                                                                        dateRecorded:
                                                                        <asp:TextBox ID="dateRecordedTextBox0" runat="server" DataFormatString="{0:d/MM/yyyy}" Text='<%# Bind("dateRecorded") %>' />
                                                                        <br />
                                                                        <asp:LinkButton ID="UpdateButton11" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                        &nbsp;<asp:LinkButton ID="UpdateCancelButton11" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                    </EditItemTemplate>
                                                                    <InsertItemTemplate>
                                                                        dateRecorded:
                                                                        <asp:TextBox ID="dateRecordedTextBox1" runat="server" DataFormatString="{0:d/MM/yyyy}" Text='<%# Bind("dateRecorded") %>' />
                                                                        <br />
                                                                        <asp:LinkButton ID="InsertButton11" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                        &nbsp;<asp:LinkButton ID="InsertCancelButton11" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                    </InsertItemTemplate>
                                                                    <ItemTemplate>
                                                                        &nbsp;<asp:Label ID="dateRecordedLabel0" runat="server" DataFormatString="{0:d/MM/yyyy}" Text='<%# Bind("dateRecorded","{0:d/MM/yyyy}") %>' ForeColor="Orange" />
                                                                        <br />
                                                                    </ItemTemplate>
                                                                </asp:FormView>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <asp:Label ID="AlertLabel65" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange">MOBI CAR WASH</asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                                <asp:FormView ID="FormView1" runat="server" BackColor="Gray" DataSourceID="DailySummary" EnableModelValidation="True" Font-Bold="True" Font-Names="Agency FB" Font-Size="X-Large" ForeColor="White" style="text-align: left; margin-right: 0px" Width="902px" CssClass="BUTTOMM">
                                                                    <EditItemTemplate>
                                                                        Served Vehicle:
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table align="left" class="auto-style339">
                                                                                            <tr>
                                                                                                <td align="center" class="auto-style396" style="border-style: none none dashed none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel18" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">CASH:</asp:Label>
                                                                                                </td>
                                                                                                <td align="left" style="border-style: none none dashed none; border-width: medium; border-color: #FFFFFF" class="auto-style398">
                                                                                                    <asp:Label ID="AlertLabel21" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("Cash", "{0:0,000}") %>'></asp:Label>
                                                                                                </td>
                                                                                                <td align="right" style="border-style: none none dashed none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel19" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">CREDIT:</asp:Label>
                                                                                                </td>
                                                                                                <td align="left" style="border-style: none none dashed none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel22" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("Credit_Amount", "{0:0,000}") %>'></asp:Label>
                                                                                                </td>
                                                                                                <td align="right" style="border-style: none none dashed none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel20" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">MOMO:</asp:Label>
                                                                                                </td>
                                                                                                <td align="left" style="border-style: none none dashed none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel23" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("momo", "{0:0,000}") %>'></asp:Label>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                        ...
                                                                                                        <table class="auto-style339">
                                                                                                            <tr>
                                                                                                                <td align="right" class="auto-style390">
                                                                                                                    <asp:Label ID="AlertLabel24" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">1-PAID CASH:</asp:Label>
                                                                                                                </td>
                                                                                                                <td align="left" class="auto-style391">
                                                                                                                    <asp:Label ID="AlertLabel27" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("Payed_Amount", "{0:0,000}") %>'></asp:Label>
                                                                                                                </td>
                                                                                                                <td>&nbsp;</td>
                                                                                                                <td align="right" class="auto-style393">
                                                                                                                    <asp:Label ID="AlertLabel30" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">4.UNPAID:</asp:Label>
                                                                                                                </td>
                                                                                                                <td align="left">
                                                                                                                    <asp:Label ID="AlertLabel35" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("unpvehi", "{0:0,000}") %>' />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td align="right" class="auto-style390">
                                                                                                                    <asp:Label ID="AlertLabel25" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">2-STAFF RPY:</asp:Label>
                                                                                                                </td>
                                                                                                                <td align="left" class="auto-style391">
                                                                                                                    <asp:Label ID="AlertLabel28" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("AmountPayedd", "{0:0,000}") %>'></asp:Label>
                                                                                                                </td>
                                                                                                                <td>&nbsp;</td>
                                                                                                                <td align="right" class="auto-style393">
                                                                                                                    <asp:Label ID="AlertLabel31" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">5-STAFF  CRDT:</asp:Label>
                                                                                                                </td>
                                                                                                                <td align="left">
                                                                                                                    <asp:Label ID="AlertLabel34" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("Staff_Credit", "{0:0,000}") %>' />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td align="right" class="auto-style390">
                                                                                                                    <asp:Label ID="AlertLabel26" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">3-CLIENTS RPY:</asp:Label>
                                                                                                                </td>
                                                                                                                <td align="left" class="auto-style391">
                                                                                                                    <asp:Label ID="AlertLabel29" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("ClientPayment", "{0:0,000}") %>' />
                                                                                                                </td>
                                                                                                                <td>&nbsp;</td>
                                                                                                                <td align="right" class="auto-style393">
                                                                                                                    <asp:Label ID="AlertLabel32" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">6-EXPENSES:</asp:Label>
                                                                                                                </td>
                                                                                                                <td align="left">
                                                                                                                    <asp:Label ID="AlertLabel33" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("Daily_Expenses", "{0:0,000}") %>' />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </asp:Panel>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="border-style: dashed none none none; border-width: medium; border-color: #FFFFFF" align="center">&nbsp;</td>
                                                                                                <td align="right" style="border-style: dashed none none none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel36" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">SERVED V:</asp:Label>
                                                                                                </td>
                                                                                                <td align="left" style="border-style: dashed none none none; border-width: medium; border-color: #FFFFFF">
                                                                                                    <asp:Label ID="AlertLabel38" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("servedVeh") %>' />
                                                                                                </td>
                                                                                                <td align="right" style="border-style: dashed none none none; border-width: medium; border-color: #FFFFFF">
                                                                                                ...
                                                                                                <td style="border-style: dashed none none none; border-width: medium; border-color: #FFFFFF" align="left">
                                                                                                    <asp:Label ID="AlertLabel39" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("Balannce", "{0:0,000}") %>' />
                                                                                                </td>
                                                                                                <td align="left" style="border-style: dashed none none none; border-width: medium; border-color: #FFFFFF">
                                                                                                    &nbsp;</td>
                                                                                            </tr>
                        ...
                        <tr>
                            <td class="auto-style231" colspan="3" valign="top">
                                ...
                                <asp:SqlDataSource ID="DailySummary" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT TOP (1) servedVeh, Cash, visaCard, unpvehi, Service_Amount, Credit_Amount, momo,Cash + momo + AmountPayedd AS CashMoMo, Payed_Amount, Staff_Credit, ClientPayment, AmountPayedd, Daily_Expenses, Balannce, ClientCreditStatus, StaffCreditStatus FROM DailyClose2 WHERE (OperationDay = @OperationDay) ORDER BY idDayCloser DESC">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <asp:SqlDataSource ID="DailySummaryBarResto" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT TOP (1) idDayCloser,DpaidLast, DSalesAmount, DPaidAmount, DExpenses, DUnpaid, OperationDay, DBalance  FROM BarDailyClose WHERE (OperationDay = @OperationDay) ORDER BY idDayCloser DESC">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                        ...
                                        <td class="style128">
                                            <asp:Panel ID="Panel48ALL" runat="server">
                                                <table class="auto-style213">
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="PanelDailyServedVehicle" runat="server">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <asp:Label ID="Label29" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="1.DAILY SERVED VEHICLES "></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <asp:Panel ID="Panel5" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                                        <table class="auto-style122">
                                                                                                ...
                                                                                                <td class="style128">
                                                                                                    <asp:Panel ID="Panel8" runat="server">
                                                                                                        <table class="auto-style339">
                                                                                                            <tr>
                                                                                                                <td align="center">
                                                                                                                    <asp:Label ID="NameService" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" Text='<%# Eval("NameService") %>'></asp:Label>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </asp:Panel>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <asp:Panel ID="Panel4" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                                        <asp:Panel ID="Panel6" runat="server">
                                                                                                            <table class="auto-style122">
                                                                                                                <tr>
                                                                                                                    <td class="auto-style158">
                                                                                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource3" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" ForeColor="#333333" GridLines="None" Width="865px" OnRowDataBound="GridView1_RowDataBound">
                                                                                                                            ...
                                                                                                                            <Columns>
                                                                                                                                ...
                                                                                                                                <ItemStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="Large" />
                                                                                                                                </asp:BoundField>
                                                                                                                                <asp:BoundField DataField="dateRecorded" HeaderText="Time" DataFormatString="{0:HH\:mm}" SortExpression="dateRecorded" > 
                                                                                                                                 <ItemStyle Font-Names="Tahoma" Font-Size="Large" />
                                                                                                                                </asp:BoundField>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td class="auto-style158">
                                                                                                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT PlateNumber, brand, [Repetition ], Price, PayedCash, Payment,Name, dateRecorded,code, userAdded FROM WebDetailsDataView WHERE NameService = @NameService  AND ([OperationDay] = @OperationDay)  ORDER BY dateRecorded">
                                                                                                                            <SelectParameters>
                                                                                                                        ...
                                                                                                                        <asp:SqlDataSource ID="SqlDataSub" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT DISTINCT NameService, SUM(Price) AS Price, SUM(PayedCash) AS PayedCash FROM WebDetailsDataView WHERE (NameService = @NameService) AND ([OperationDay] = @OperationDay) AND (Payment != 'Credit')  GROUP BY NameService">
                                                                                                                            <SelectParameters>
                                                                                                                                <asp:ControlParameter ControlID="NameService" Name="NameService" PropertyName="Text" />
                                                                                                                                <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                            </SelectParameters>
                                                                                                                        </asp:SqlDataSource>
                                                                                                                        <asp:SqlDataSource ID="SqlDataSub0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT DISTINCT NameService, SUM(Price) AS Price, SUM(PayedCash) AS PayedCash FROM WebDetailsDataView WHERE (NameService = @NameService) AND ([OperationDay] = @OperationDay)   GROUP BY NameService">
                                                                                                                            <SelectParameters>
                                                                                                                                <asp:ControlParameter ControlID="NameService" Name="NameService" PropertyName="Text" />
                                                                                                                                <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                            </SelectParameters>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel88" runat="server">
                                                                                <table class="auto-style339">
                                                                                    <tr>
                                                                                        <td>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:FormView ID="FormView20" runat="server" DataSourceID="DailySummary0" EnableModelValidation="True">
                                                                                                <EditItemTemplate>
                                                                                                    ...
                                                                                                    <br />
                                                                                                    momo:
                                                                                                    <asp:TextBox ID="momoTextBox1" runat="server" Text='<%# Bind("momo") %>' />
                                                                                                    <br />
                                                                                                    CashMoMo:
                                                                                                    <asp:TextBox ID="CashMoMoTextBox" runat="server" Text='<%# Bind("CashMoMo") %>' />
                                                                                                    <br />
                                                                                                    <asp:LinkButton ID="UpdateButton22" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                                                    &nbsp;<asp:LinkButton ID="UpdateCancelButton22" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                </EditItemTemplate>
                                                                                                <InsertItemTemplate>
                                                                                                    Cash:
                                                                                                    <asp:TextBox ID="CashTextBox0" runat="server" Text='<%# Bind("Cash") %>' />
                                                                                                    <br />
                                                                                                    momo:
                                                                                                    <asp:TextBox ID="momoTextBox2" runat="server" Text='<%# Bind("momo") %>' />
                                                                                                    <br />
                                                                                                    CashMoMo:
                                                                                                    <asp:TextBox ID="CashMoMoTextBox0" runat="server" Text='<%# Bind("CashMoMo") %>' />
                                                                                                    <br />
                                                                                                    <asp:LinkButton ID="InsertButton22" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                                                    &nbsp;<asp:LinkButton ID="InsertCancelButton22" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                </InsertItemTemplate>
                                                                                                <ItemTemplate>
                                                                                                    <table class="auto-style170">
                                                                                                        <tr>
                                                                                                            <td style="text-align: right">
                                                                                                                <asp:Label ID="Label60" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="White" Text="Total Payed:"></asp:Label>
                                                                                                            </td>
                                                                                                            <td style="text-align: left">
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT0" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label34" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="2.CLIENTS DAILY CREDIT "></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <asp:Panel ID="Panel37" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                            ...
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="dailyCredit" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="#333333" GridLines="None" OnRowDataBound="GridView3_RowDataBound" Width="867px">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                ...
                                                                                                                <asp:BoundField DataField="dateRecorded" DataFormatString="{0:HH\:m}" HeaderText="Time" SortExpression="dateRecorded">
                                                                                                                <HeaderStyle Font-Bold="False" />
                                                                                                                <ItemStyle Font-Bold="False" />
                                                                                                                </asp:BoundField>
                                                                                                                <asp:BoundField DataField="userAdded" HeaderText="Operator" SortExpression="userAdded">
                                                                                                    ...
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <table class="auto-style213">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td align="right" class="auto-style275">&nbsp;</td>
                                                                                                                <td style="text-align: left">
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT3" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label64" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Text="3.CLIENTS DAILY CREDIT AND PAYMENT HISTORIC"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <asp:Panel ID="Panel87" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="GridClientPayment0" runat="server" AutoGenerateColumns="False" CellPadding="8" DataSourceID="ClientHistoric" EnableModelValidation="True" Font-Names="Tahoma" ForeColor="#333333" GridLines="None" Width="867px" Font-Bold="False" Font-Size="Large">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                        ...
                                                                                                        <table class="auto-style213">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="auto-style386">
                                                                                                                    <asp:SqlDataSource ID="ClientHistoric0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM([Remain]) AS Remain  FROM [ViewPaymentNew] WHERE OperationDay=@OperationDay">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                                </td>
                                                                                                                <td class="auto-style387" valign="top">&nbsp;</td>
                                                                                                                <td style="text-align: left">
                                                                                                                    <asp:SqlDataSource ID="ClientHistoric1" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM([paid]) AS paid  FROM [ViewPaymentNew] WHERE OperationDay=@OperationDay">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="auto-style272">&nbsp;</td>
                                                                                                                <td class="auto-style386">
                                                                                                                    <asp:FormView ID="FormView33" runat="server" DataSourceID="ClientHistoric0" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            amount:
                                                                                                                            <asp:TextBox ID="amountTextBox4" runat="server" Text='<%# Bind("Remain") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="UpdateButton26" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                                                                            &nbsp;<asp:LinkButton ID="UpdateCancelButton26" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </EditItemTemplate>
                                                                                                                        <InsertItemTemplate>
                                                                                                                            amount:
                                                                                                                            <asp:TextBox ID="amountTextBox5" runat="server" Text='<%# Bind("Remain") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="InsertButton26" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                                                                            &nbsp;<asp:LinkButton ID="InsertCancelButton26" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </InsertItemTemplate>
                                                                                                                        <ItemTemplate>
                                                                                                                            <asp:Panel ID="Panel91" runat="server">
                                                                                                                                <table>
                                                                                                                                    <tr>
                                                                                                                                        <td style="text-align: right">
                                                                                                                                            <asp:Label ID="Label67" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="White" Text="Total Given:"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="text-align: left">
                                                                                                                                            <asp:Label ID="amountLabel2" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Orange" Text='<%# Bind("Remain") %>' />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </asp:Panel>
                                                                                                                ...
                                                                                                                <td style="text-align: left">
                                                                                                                    <asp:FormView ID="FormView34" runat="server" DataSourceID="ClientHistoric1" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            amount:
                                                                                                                            <asp:TextBox ID="amountTextBox6" runat="server" Text='<%# Bind("paid") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="UpdateButton27" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                                                                            &nbsp;<asp:LinkButton ID="UpdateCancelButton27" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </EditItemTemplate>
                                                                                                                        <InsertItemTemplate>
                                                                                                                            amount:
                                                                                                                            <asp:TextBox ID="amountTextBox7" runat="server" Text='<%# Bind("paid") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="InsertButton27" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                                                                            &nbsp;<asp:LinkButton ID="InsertCancelButton27" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </InsertItemTemplate>
                                                                                                                        <ItemTemplate>
                                                                                                                            <asp:Panel ID="Panel92" runat="server">
                                                                                                                                <table>
                                                                                                                                    <tr>
                                                                                                                                        <td style="text-align: right">
                                                                                                                                            <asp:Label ID="Label68" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="White" Text="Total Repay:"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="text-align: left">
                                                                                                                                            <asp:Label ID="amountLabel3" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Orange" Text='<%# Bind("paid") %>' />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </asp:Panel>
                                                                ...
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td style="text-align: center">
                                                                            <asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="4.STAFF DAILY CREDIT AND PAYMENT"></asp:Label>
                                                                            <asp:SqlDataSource ID="StaffHistoricView" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [StaffName],(newBalance-amount+Payment) as oldCredit, [amount],[Payment], [newBalance], [dateClose],[idStaffCredit],[NameCredit],[userAdded] FROM [StaffCreditReports1] WHERE (OperationDay = @OperationDay) AND ([NameCredit]='Credit') AND (amount&gt;0 OR Payment&gt;0) ORDER BY [dateClose] DESC">
                                                                                <SelectParameters>
                                                                                    <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                </SelectParameters>
                                                                            </asp:SqlDataSource>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel79" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="gvInformation4" runat="server" AutoGenerateColumns="False" CellPadding="8" DataSourceID="StaffHistoricView" EnableModelValidation="True" Font-Names="Tahoma" ForeColor="#333333" GridLines="None" Height="56px" style="margin-left: 0px" Width="867px" Font-Size="Large">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td style="text-align: center">
                                                                            <asp:Label ID="Label55" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="5.STAFF DAILY UNPAID AND PAYMENT"></asp:Label>
                                                                            <asp:SqlDataSource ID="StaffHistoricView0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT StaffName, newBalance - amount + Payment AS oldCredit, amount, Payment, newBalance, dateClose, idStaffCredit, NameCredit, userAdded FROM StaffCreditReports1 WHERE (OperationDay = @OperationDay) AND (NameCredit = 'Unpaid') AND (amount&gt;0 OR Payment&gt;0) ORDER BY dateClose DESC">
                                                                                <SelectParameters>
                                                                                    <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                </SelectParameters>
                                                                            </asp:SqlDataSource>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel33" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="gvInformation5" runat="server" AutoGenerateColumns="False" CellPadding="8" DataSourceID="StaffHistoricView0" EnableModelValidation="True" Font-Names="Tahoma" ForeColor="#333333" GridLines="None" Height="56px" style="margin-left: 0px" Width="867px" Font-Size="Large">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:FormView ID="FormView8" runat="server" DataSourceID="StaffHistoricViewCredit" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            amount:
                                                                                                                            <asp:TextBox ID="amountTextBox2" runat="server" Text='<%# Bind("amount") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="UpdateButton24" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                                                                            &nbsp;<asp:LinkButton ID="UpdateCancelButton24" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </EditItemTemplate>
                                                                                                                        <InsertItemTemplate>
                                                                                                                            amount:
                                                                                                                            <asp:TextBox ID="amountTextBox3" runat="server" Text='<%# Bind("amount") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="InsertButton24" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                                                                            &nbsp;<asp:LinkButton ID="InsertCancelButton24" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </InsertItemTemplate>
                                                                                                                        <ItemTemplate>
                                                                                                                            <asp:Panel ID="Panel89" runat="server">
                                                                                                                                <table>
                                                                                                                                    <tr>
                                                                                                                                        <td style="text-align: right">
                                                                                                                                            <asp:Label ID="Label65" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="White" Text="Total Credit:"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="text-align: left">
                                                                                                                                            <asp:Label ID="amountLabel1" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Orange" Text='<%# Bind("amount") %>' />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </asp:Panel>
                                                                                                                ...
                                                                                                                <td style="text-align: right">
                                                                                                                    <asp:FormView ID="FormView9" runat="server" DataSourceID="StaffHistoricViewPayment" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            ...
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="UpdateButton25" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                                                                            &nbsp;<asp:LinkButton ID="UpdateCancelButton25" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </EditItemTemplate>
                                                                                                                        <InsertItemTemplate>
                                                                                                                            Payment:
                                                                                                                            <asp:TextBox ID="PaymentTextBox2" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="InsertButton25" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                                                                            &nbsp;<asp:LinkButton ID="InsertCancelButton25" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </InsertItemTemplate>
                                                                                                                        <ItemTemplate>
                                                                                                                            <asp:Panel ID="Panel90" runat="server">
                                                                                                                                <table>
                                                                                                                                    <tr>
                                                                                                                                        <td style="text-align: right">
                                                                                                                                            <asp:Label ID="Label66" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="White" Text="Total Payment:"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="text-align: left">
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:Panel ID="PanelDAILYEXPENSES" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <asp:Label ID="Label31" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="6.DAILY EXPENSES ON:"></asp:Label>
                                                                            &nbsp;</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel34" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="DAILYEXPENSES" EnableModelValidation="True" Font-Bold="True" Font-Names="Tahoma" Font-Size="Large" ForeColor="#333333" GridLines="None" Width="867px">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                ...
                                                                                                                <asp:BoundField DataField="dateAdded" DataFormatString="{0:d/MM/yyyy}" HeaderText="dateAdded" SortExpression="dateAdded">
                                                                                                                <HeaderStyle Font-Bold="False" />
                                                                                                                <ItemStyle Font-Bold="False" />
                                                                                                                </asp:BoundField>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:Label ID="Label71" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="Orange" Text="MAÏSHA CAFE"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">
                                                            <asp:FormView ID="FormView42" runat="server" DataFormatString="{0:d/MM/yyyy}" DataSourceID="SqlDataSourceDATE" EnableModelValidation="True" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White">
                                                                <EditItemTemplate>
                                                                    dateRecorded:
                                                                    <asp:TextBox ID="dateRecordedTextBox2" runat="server" DataFormatString="{0:d/MM/yyyy}" Text='<%# Bind("dateRecorded") %>' />
                                                                    <br />
                                                                ...
                                                                <InsertItemTemplate>
                                                                    dateRecorded:
                                                                    <asp:TextBox ID="dateRecordedTextBox3" runat="server" DataFormatString="{0:d/MM/yyyy}" Text='<%# Bind("dateRecorded") %>' />
                                                                    <br />
                                                                ...
                                                                <ItemTemplate>
                                                                    &nbsp;<asp:Label ID="dateRecordedLabel1" runat="server" DataFormatString="{0:d/MM/yyyy}" ForeColor="Orange" Text='<%# Bind("dateRecorded","{0:d/MM/yyyy}") %>' />
                                                                    <br />
                                                                </ItemTemplate>
                                                            </asp:FormView>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:FormView ID="FormView35" runat="server" BackColor="Gray" CssClass="BUTTOMM" DataSourceID="DailySummaryBarResto" EnableModelValidation="True" Font-Bold="True" Font-Names="Agency FB" Font-Size="X-Large" ForeColor="White" style="text-align: left; margin-right: 0px" Width="902px">
                                                                <EditItemTemplate>
                                                                    Served Vehicle:
                                                                                ...
                                                                                <td>
                                                                                    <table align="left" class="auto-style339">
                                                                                            ...
                                                                                            <td align="center" class="auto-style389" colspan="6">
                                                                                                <asp:Panel ID="Panel101" runat="server">
                                                                                                    <table class="auto-style339">
                                                                                                        <tr>
                                                                                                            <td align="right" class="auto-style390">
                                                                                                                <asp:Label ID="AlertLabel48" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">1-SALES :</asp:Label>
                                                                                                            </td>
                                                                                                            <td align="left" class="auto-style391">
                                                                                                                <asp:Label ID="AlertLabel49" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("DSalesAmount", "{0:0,000}") %>'></asp:Label>
                                                                                                            </td>
                                                                                                            <td>&nbsp;</td>
                                                                                                            <td align="right" class="auto-style393">
                                                                                                                <asp:Label ID="AlertLabel50" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">2.PAID :</asp:Label>
                                                                                                            </td>
                                                                                                            <td align="left">
                                                                                                                <asp:Label ID="AlertLabel51" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("DPaidAmount", "{0:0,000}") %>' />
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td align="right" class="auto-style390">
                                                                                                                <asp:Label ID="AlertLabel56" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">3-UNPAID:</asp:Label>
                                                                                                            </td>
                                                                                                            <td align="left" class="auto-style391">
                                                                                                                <asp:Label ID="AlertLabel57" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("DUnpaid", "{0:0,000}") %>' />
                                                                                                            </td>
                                                                                                            <td>&nbsp;</td>
                                                                                                            <td align="right" class="auto-style393">
                                                                                                            ...
                                                                                                            <td align="left">
                                                                                                                <asp:Label ID="AlertLabel59" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("DExpenses", "{0:0,000}") %>' />
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td align="right" class="auto-style390">
                                                                                                                <asp:Label ID="AlertLabel62" runat="server" CssClass="FONTSIZER" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White">5-REPAY:</asp:Label>
                                                                                                            </td>
                                                                                                            <td align="left" class="auto-style391">
                                                                                                                <asp:Label ID="AlertLabel63" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("DpaidLast", "{0:0,000}") %>' />
                                                                                                            </td>
                                                                                                            <td>&nbsp;</td>
                                                                                                            <td align="right" class="auto-style393">
                                                                                                                &nbsp;</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left">
                                                                                                <asp:Label ID="AlertLabel61" runat="server" CssClass="LABELINCREASE" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Orange" Text='<%# Eval("DBalance", "{0:0,000}") %>' />
                                                                                            </td>
                                                                                            <td align="left">&nbsp;</td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td align="left">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT5" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label75" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="7.PAYMENT DETAILS"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel105" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        ...
                                                                                                        <asp:GridView ID="GridClientPayment2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="Command1" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Medium" ForeColor="#333333" GridLines="None" Width="867px" OnRowDataBound="GridClientPayment2_RowDataBound" ShowFooter="True" DataKeyNames="idCommand" OnSelectedIndexChanged="GridClientPayment2_SelectedIndexChanged">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                 <asp:BoundField DataField="idCommand" HeaderText="Ref No" SortExpression="idCommand">
                                                                                                                  ...
                                                                                                                  <asp:TemplateField>
                                                                                                                            <ItemTemplate>
                                                                                                                                <asp:Button ID="Button37" runat="server" BackColor="#006666" BorderStyle="Solid" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="White" Height="26px"  onmouseout="this.style.backgroundColor='#006666'" onmouseover="this.style.backgroundColor='Orange'" Text="View" Width="80px" OnClick="Button37_Click2" BorderColor="White" BorderWidth="1px" />
                                                                                                                            </ItemTemplate>                                                                                                                       
                                                                                                                            <ItemStyle CssClass="input" Font-Bold="False" HorizontalAlign="Right" BackColor="#006666" />
                                                                                                                        </asp:TemplateField>                                                                                                              
                                                                                                            </Columns>
                                                                                                        </asp:GridView>
                                                                                                    </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT6" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label76" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="8.SALES SUMMARY "></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel106" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="GridClientPayment3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ServedDrink0" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="#333333" GridLines="None" Width="867px">
                                                                                                            <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                            <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                            <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <table class="auto-style213">
                                                                                                            <tr>
                                                                                                                <td class="auto-style272">
                                                                                                                    <asp:SqlDataSource ID="ServedDrink0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM(PriceSales * quantity) AS Total, SUM(quantity) AS quantity, productName, PriceSales, OperationDay, requestStatus FROM BarRequestViewStock WHERE (OperationDay = @OperationDay) AND (quantity &gt; 0) AND (requestStatus = 'confirmed') GROUP BY productName, requestStatus, PriceSales, OperationDay">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                                ...
                                                                                                                <td class="auto-style386">
                                                                                                                    <asp:SqlDataSource ID="ServedDrinkTotal" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT  SUM(PriceSales * quantity) AS Total FROM BarRequestViewStock WHERE (OperationDay = @OperationDay) and (requestStatus='confirmed')">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                                ...
                                                                                                                <td class="auto-style387">&nbsp;</td>
                                                                                                                <td align="right">
                                                                                                                    <asp:FormView ID="FormView37" runat="server" DataSourceID="ServedDrinkTotal" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            Payment:
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT4" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label72" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="9. SALES DETAILS"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top">
                                                                            <asp:SqlDataSource ID="ServedDrinkCategory" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT DISTINCT CategoryName FROM BarRequestViewStock WHERE (OperationDay = @OperationDay) and (requestStatus='confirmed') ">
                                                                                <SelectParameters>
                                                                                    <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                </SelectParameters>
                                                                            </asp:SqlDataSource>
                                                                            <asp:DataList ID="DataList5" runat="server" DataSourceID="ServedDrinkCategory">
                                                                                <ItemTemplate>
                                                                                    <asp:Panel ID="Panel102" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                        <table class="auto-style26">
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <table class="auto-style26">
                                                                                                        <tr>
                                                                                                            <td align="center" style="font-weight: 700" valign="top">
                                                                                                                <asp:Label ID="Category" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text='<%# Eval("CategoryName") %>'></asp:Label>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td style="font-weight: 700" valign="top">
                                                                                                                <table class="auto-style213">
                                                                                                                    <tr>
                                                                                                                        <td class="auto-style272" colspan="4">
                                                                                                                            <asp:GridView ID="GridClientPayment1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ServedDrink" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="#333333" GridLines="None" Width="867px">
                                                                                                                                <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                                                <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                                                <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                                                <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td class="auto-style272">
                                                                                                                            <asp:SqlDataSource ID="ServedDrink" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT idCommand, SUM(PriceSales * quantity) AS Total, SUM(quantity) AS quantity, productName, requestStatus, PriceSales, OperationDay, Time, CategoryName, userAdded FROM BarRequestViewStock WHERE (OperationDay = @OperationDay) AND (requestStatus = 'confirmed') AND (CategoryName = @CategoryName) AND (quantity &gt; 0) GROUP BY idCommand, requestStatus, productName, Time, PriceSales, OperationDay, CategoryName, userAdded ORDER BY Time">
                                                                                                                                <SelectParameters>
                                                                                                                                    <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                                    <asp:ControlParameter ControlID="Category" Name="CategoryName" PropertyName="Text" />
                                                                                                                                </SelectParameters>
                                                                                                                            </asp:SqlDataSource>
                                                                                                                        </td>
                                                                                                                        <td class="auto-style386">
                                                                                                                            <asp:SqlDataSource ID="ServedDrinkTotal0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" OnSelecting="ServedDrinkTotal0_Selecting" SelectCommand="SELECT  SUM(PriceSales * quantity) AS Total FROM BarRequestViewStock WHERE (OperationDay = @OperationDay) and (requestStatus='confirmed') and CategoryName=@CategoryName">
                                                                                                                                <SelectParameters>
                                                                                                                                    <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                                                                    <asp:ControlParameter ControlID="Category" Name="CategoryName" PropertyName="Text" />
                                                                                                                                </SelectParameters>
                                                                                                                        ...
                                                                                                                        <td class="auto-style387">&nbsp;</td>
                                                                                                                        <td align="right">
                                                                                                                            <asp:FormView ID="FormView38" runat="server" DataSourceID="ServedDrinkTotal0" EnableModelValidation="True">
                                                                                                                                <EditItemTemplate>
                                                                                                                                    Payment:
                                                                                                                                    <asp:TextBox ID="PaymentTextBox7" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                                    <br />
                                                                                                                                ...
                                                                                                                                <InsertItemTemplate>
                                                                                                                                    Payment:
                                                                                                                                    <asp:TextBox ID="PaymentTextBox8" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                                    <br />
                                                                                                                                ...
                                                                                                                                <ItemTemplate>
                                                                                                                                    <asp:Panel ID="Panel109" runat="server">
                                                                                                                                        <table>
                                                                                                                                            <tr>
                                                                                                                                                <td style="text-align: right">
                                                                                                                                                    <asp:Label ID="Label79" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Text="TOTAL:"></asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td style="text-align: left">
                                                                                                                                                    <asp:Label ID="PaymentLabel3" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="Orange" Text='<%# Eval("Total") %>' />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                        </table>
                                                                                                                                    </asp:Panel>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT9" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label91" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="10.REPAID CREDITS"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel127" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="gvInformation21" runat="server" AutoGenerateColumns="False" BackColor="#333333" BorderColor="#333333" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataSourceID="Expenses1" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="Black" GridLines="None" style="margin-left: 0px" Width="867px">
                                                                                                            <Columns>
                                                                                                               <asp:BoundField DataField="idCommand" HeaderText="Ref No" SortExpression="idCommand">
                                                                                                                                                    <FooterStyle ForeColor="#244242" />
                                                                                                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                                                                ...
                                                                                                                <asp:BoundField DataField="AmountPaid" HeaderText="Repaid Amount" SortExpression="AmountPaid">
                                                                                                                <ItemStyle Font-Bold="False" />
                                                                                                                </asp:BoundField>
                                                                                                                <asp:BoundField DataField="userAdded" HeaderText="Operator" SortExpression="userAdded">
                                                                                                                <FooterStyle ForeColor="#244242" />
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <table class="auto-style213">
                                                                                                            <tr>
                                                                                                                <td class="auto-style272">
                                                                                                                    <asp:SqlDataSource ID="Expenses1" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT  idPayment, idCommand, userAdded, dateAdded, OperationDay, operationMonth, operationYear, AmountPaid, status FROM            BarPayment WHERE ([OperationDay] = @OperationDay)">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                                ...
                                                                                                                <td class="auto-style386">
                                                                                                                    <asp:SqlDataSource ID="Expenses2" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM(AmountPaid) AS amount FROM BarPayment WHERE (OperationDay = @OperationDay)">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                                ...
                                                                                                                <td class="auto-style387">&nbsp;</td>
                                                                                                                <td align="right">
                                                                                                                    <asp:FormView ID="FormView44" runat="server" DataSourceID="Expenses2" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            Payment:
                                                                                                                            <asp:TextBox ID="PaymentTextBox15" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="UpdateButton39" runat="server" CausesValidation="True" CommandName="Update" Text="Update" />
                                                                                                                            &nbsp;<asp:LinkButton ID="UpdateCancelButton39" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </EditItemTemplate>
                                                                                                                        <InsertItemTemplate>
                                                                                                                            Payment:
                                                                                                                            <asp:TextBox ID="PaymentTextBox16" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                            <br />
                                                                                                                            <asp:LinkButton ID="InsertButton39" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" />
                                                                                                                            &nbsp;<asp:LinkButton ID="InsertCancelButton39" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                                                                                                                        </InsertItemTemplate>
                                                                                                                        <ItemTemplate>
                                                                                                                            <asp:Panel ID="Panel128" runat="server">
                                                                                                                                <table>
                                                                                                                                    <tr>
                                                                                                                                        <td style="text-align: right">
                                                                                                                                            <asp:Label ID="Label92" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Text="TOTAL:"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="text-align: left">
                                                                                                                                            <asp:Label ID="PaymentLabel7" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="Orange" Text='<%# Eval("amount") %>' />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </asp:Panel>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="PanelSTAFFDAILYCREDIT7" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <table class="auto-style339">
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <asp:Label ID="Label87" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Text="11.EXPENSES"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel122" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <asp:GridView ID="gvInformation13" runat="server" AutoGenerateColumns="False" BackColor="#333333" BorderColor="#333333" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataSourceID="Expenses" EnableModelValidation="True" Font-Bold="False" Font-Names="Tahoma" Font-Size="Large" ForeColor="Black" GridLines="None" style="margin-left: 0px" Width="867px">
                                                                                                            <Columns>
                                                                                                                <asp:TemplateField HeaderText="Sno">
                                                                                                                    <ItemTemplate>
                                                                                                                        <%# Container.DataItemIndex + 1 %>
                                                                                                    ...
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <table class="auto-style213">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="auto-style386">
                                                                                                                    <asp:SqlDataSource ID="Expenses0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM(amount) AS amount FROM ExpensesReports2 WHERE (OperationDay = @OperationDay)">
                                                                                                                        <SelectParameters>
                                                                                                                            <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                                                                                                        </SelectParameters>
                                                                                                                    </asp:SqlDataSource>
                                                                                                                ...
                                                                                                                <td class="auto-style387">&nbsp;</td>
                                                                                                                <td align="right">
                                                                                                                    <asp:FormView ID="FormView40" runat="server" DataSourceID="Expenses0" EnableModelValidation="True">
                                                                                                                        <EditItemTemplate>
                                                                                                                            Payment:
                                                                                                                            <asp:TextBox ID="PaymentTextBox11" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                            <br />
                                                                                                                        ...
                                                                                                                        <InsertItemTemplate>
                                                                                                                            Payment:
                                                                                                                            <asp:TextBox ID="PaymentTextBox12" runat="server" Text='<%# Bind("Payment") %>' />
                                                                                                                            <br />
                                                                                                                        ...
                                                                                                                        <ItemTemplate>
                                                                                                                            <asp:Panel ID="Panel123" runat="server">
                                                                                                                                <table>
                                                                                                                                    <tr>
                                                                                                                                        <td style="text-align: right">
                                                                                                                                            <asp:Label ID="Label88" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Text="TOTAL:"></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="text-align: left">
                                                                                                                                            <asp:Label ID="PaymentLabel5" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="Orange" Text='<%# Eval("amount") %>' />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </table>
                                                                                                                            </asp:Panel>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="PanelClientMna" runat="server" BackColor="Gray" Visible="False">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td style="text-align: center">
                                                                            &nbsp;</td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: center">
                                                                            <asp:SqlDataSource ID="ProductName" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT DISTINCT productName FROM BarSalesPurchaseHistoricView2">
                                                                            </asp:SqlDataSource>
                                                                            <asp:SqlDataSource ID="ProductName0" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT DISTINCT productName FROM BarSalesPurchaseHistoricView WHERE (OperationDay = @OperationDay) and (idDrinkCategory != '3')">
                                                                                <SelectParameters>
                                                                                    <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                                                                </SelectParameters>
                                                                            </asp:SqlDataSource>
                                                                                        ...
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                        ...
                                                                                                        <table class="auto-style213">
                                                                                                            <tr>
                                                                                                                <td class="auto-style274" valign="top">
                                                                                                                    <asp:Panel ID="PanelCantineAll" runat="server">
                                                                                                                        <table class="auto-style339">
                                                                                                                            <tr>
                                                                                                                                <td>
                                                                                                                                    <asp:Panel ID="PanelNewProduct" runat="server" BackColor="#244242" Visible="False" Width="100%">
                                                                                                                                        <table class="auto-style213">
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" bgcolor="#006666" class="auto-style406" colspan="2">
                                                                                                                                                    <asp:Label ID="AlertLabel12" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="Orange">Add New Product</asp:Label>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style406">
                                                                                                                                                    &nbsp;</td>
                                                                                                                                                <td align="left">
                                                                                                                                                    <asp:Panel ID="Panel47" runat="server" BackColor="#006666" CssClass="BUTTOM0" Width="449px">
                                                                                                                                                        <table class="auto-style4">
                                                                                                                                                            <tr>
                                                                                                                                                                <td>
                                                                                                                                                                    <asp:TextBox ID="TextBox28" runat="server" BackColor="White" BorderStyle="None" CssClass="BUTTOM" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Navy" Height="30px" placeholder="Search ...." Width="232px" OnTextChanged="TextBox28_TextChanged"></asp:TextBox>
                                                                                                                                                                </td>
                                                                                                                                                                <td>
                                                                                                                                                                    <asp:Button ID="Button47" runat="server" BackColor="#006666" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="48px" OnClick="Button47_Click" onmouseout="this.style.backgroundColor='#006666'" onmouseover="this.style.backgroundColor='Orange'" Text="Search" Width="145px" />
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                                                                                                                        </table>
                                                                                                                                                    </asp:Panel>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style406">
                                                                                                                                                    <asp:Label ID="AlertLabel13" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White"></asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td align="center">
                                                                                                                                                    <asp:Label ID="Label69" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White"></asp:Label>
                                                                                                                                                    <asp:TextBox ID="TextBox64" runat="server" Visible="False"></asp:TextBox>
                                                                                                                                                    <asp:SqlDataSource ID="DrinkCategory" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [idDrinkCategory], [CategoryName] FROM [BarDrinksCategory]"></asp:SqlDataSource>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="right" class="auto-style406">
                                                                                                                                                    <asp:Label ID="Label81" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White">Item Names</asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td align="left">
                                                                                                                                                    <asp:TextBox ID="TextBox41" runat="server" BackColor="#244242" BorderColor="White" BorderStyle="Solid" CssClass="BUTTOM" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="30px" placeholder="Product Name" Width="449px"></asp:TextBox>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="right" class="auto-style406">
                                                                                                                                                    <asp:Label ID="Label82" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White">Purchase Price</asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td align="left">
                                                                                                                                                    <asp:TextBox ID="TextBox63" runat="server" BackColor="#244242" BorderColor="White" BorderStyle="Solid" CssClass="BUTTOM" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="30px" placeholder="Buying Price" Width="449px"></asp:TextBox>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="right" class="auto-style406">
                                                                                                                                                    <asp:Label ID="Label83" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White">Sales Price</asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td align="left">
                                                                                                                                                    <asp:TextBox ID="TextBox70" runat="server" BackColor="#244242" BorderColor="White" BorderStyle="Solid" CssClass="BUTTOM" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="30px" placeholder="Salling Price" Width="449px"></asp:TextBox>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="right" class="auto-style406">
                                                                                                                                                    <asp:Label ID="Label84" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White">Category</asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td align="left">
                                                                                                                                                    <asp:DropDownList ID="DropDownList21" runat="server" AutoPostBack="True" BackColor="#244242" CssClass="BUTTOMNUMBER" DataSourceID="DrinkCategory" DataTextField="CategoryName" DataValueField="idDrinkCategory" Font-Size="X-Large" ForeColor="White" Height="40px" Width="470px">
                                                                                                                                                    </asp:DropDownList>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="right" class="auto-style406">
                                                                                                                                                    <asp:Label ID="Label85" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White">Unit</asp:Label>
                                                                                                                                                </td>
                                                                                                                                                <td align="left">
                                                                                                                                                    <asp:DropDownList ID="DropDownList22" runat="server" AutoPostBack="True" BackColor="#244242" CssClass="BUTTOMNUMBER" DataSourceID="Unit" DataTextField="UnitName" DataValueField="IdUnit" Font-Size="X-Large" ForeColor="White" Height="40px" Width="470px">
                                                                                                                                                    </asp:DropDownList>
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" class="auto-style406" colspan="2">
                                                                                                                                                    <br />
                                                                                                                                                    <asp:Button ID="Button75" runat="server" BackColor="#006666" BorderStyle="None" CssClass="Panel1Registration" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="60px" OnClick="Button75_Click" onmouseout="this.style.backgroundColor='#006666'" onmouseover="this.style.backgroundColor='Orange'" Text="Submit" Width="310px" />
                                                                                                                                                    <asp:Button ID="Button76" runat="server" BackColor="#006666" BorderStyle="None" CssClass="Panel1Registration" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="60px" OnClick="Button76_Click" onmouseout="this.style.backgroundColor='#006666'" onmouseover="this.style.backgroundColor='Orange'" Text="Update" Width="276px" />
                                                                                                                                                    <br />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" colspan="2">
                                                                                                                                                    <asp:GridView ID="gvInformation7" runat="server" AutoGenerateColumns="False" BackColor="#244242" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="Horizontal" style="margin-left: 0px" Width="100%">
                                                                                                                                                        <Columns>
                                                                                                                                                            <%-- <asp:TemplateField>
                                                                                                                                <ItemTemplate>
                                                                                                                                    <asp:CheckBox ID="CheckBox14" runat="server" BackColor="Gray" CausesValidation="True" CssClass="ChkBoxClassok1" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="31px" OnCheckedChanged="CheckBox14_CheckedChanged" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="34px" AutoPostBack="True" />
                                                                                                                                </ItemTemplate>
                                                                                                                                ...
                                                                                                                                <ItemStyle BackColor="#244242" CssClass="input" HorizontalAlign="Left" />
                                                                                                                                                            ...
                                                                                                                                                            <asp:TemplateField HeaderText="Edit">
                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                    <asp:CheckBox ID="CheckBox14" runat="server" AutoPostBack="True" BackColor="#006666" CssClass="ChkBoxClassok1" Height="31px" OnCheckedChanged="CheckBox14_CheckedChanged1" Width="34px" />
                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                <FooterStyle BackColor="White" />
                                                                                                                                                            ...
                                                                                                                                                            <FooterStyle ForeColor="#006666" Width="10px" />
                                                                                                                                                            <HeaderStyle Width="10px" Wrap="True" />
                                                                                                                                                            <ItemStyle Font-Size="Smaller" ForeColor="#006666" HorizontalAlign="Center" Width="10px" />
                                                                                                                                                            </asp:BoundField>
                                                                                                                                                            <asp:BoundField DataField="productName" HeaderText="Products" SortExpression="productName">
                                                                                                                                                            <HeaderStyle HorizontalAlign="Left" Wrap="True" />
                                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Left" />
                                                                                                                                                            </asp:BoundField>
                                                                                                                                                            <asp:BoundField DataField="PricePurchase" HeaderText="Price-P" SortExpression="PricePurchase">
                                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                                            <ControlStyle Font-Size="Large" Width="250px" />
                                                                                                                                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Center" Wrap="True" />
                                                                                                                                                            </asp:BoundField>
                                                                                                                                                            <asp:BoundField DataField="PriceSales" HeaderText="Price-S" SortExpression="PriceSales">
                                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                                            <ControlStyle Font-Size="Large" Width="250px" />
                                                                                                                                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Center" Wrap="True" />
                                                                                                                                                            ...
                                                                                                                                                            <ControlStyle Font-Size="Large" Width="250px" />
                                                                                                                                                            <HeaderStyle HorizontalAlign="Left" Wrap="True" />
                                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Left" Wrap="True" />
                                                                                                                                                            </asp:BoundField>
                                                                                                                                                            ...
                                                                                                                                                            <asp:BoundField DataField="idDrinkCategory"  SortExpression="idDrinkCategory">
                                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Center" Font-Size="Smaller" ForeColor="#006666" />
                                                                                                                                                            </asp:BoundField>
                                                                                                                                                             <asp:BoundField DataField="IdUnit" SortExpression="IdUnit">
                                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Center" Font-Size="Smaller" ForeColor="#006666" />
                                                                                                                                                            </asp:BoundField>                                                                                                                                                           
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td>
                                                                                                                                    <asp:Panel ID="PanelNewProduct0" runat="server" BackColor="Gray" Visible="False" Width="100%">
                                                                                                                                        <table class="auto-style213">
                                                                                                                                            <tr>
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="center">
                                                                                                                                                    <asp:Panel ID="Panel115" runat="server" BackColor="#244242">
                                                                                                                                                        <table class="auto-style339">
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center">
                                                                                                                                                                    ...
                                                                                                                                                                    <asp:Label ID="idProductID" runat="server" Text="idProductID" Visible="False"></asp:Label>
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center">
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center" class="auto-style407">
                                                                                                                                                                    <asp:SqlDataSource ID="ProductsSkol" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT idProduct, productName, quantityStock, PriceSales, PricePurchase, idDrinkCategory FROM BarProducts WHERE (idDrinkCategory = @idDrinkCategory) ORDER BY productName">
                                                                                                                                                                        <SelectParameters>
                                                                                                                                                                            <asp:Parameter DefaultValue="1" Name="idDrinkCategory" Type="Int32" />
                                                                                                                                                                        </SelectParameters>
                                                                                                                                                                    </asp:SqlDataSource>
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td>
                                                                                                                                                                    <asp:GridView ID="gvInformation11" runat="server" AutoGenerateColumns="False" BackColor="#006666" BorderColor="#666666" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataSourceID="ProductsSkol" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" GridLines="None" style="margin-left: 0px" Width="100%" DataKeyNames="idProduct">
                                                                                                                                                                        <Columns>
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:CheckBox ID="CheckBox18" runat="server"  CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle ForeColor="Navy" />
                                                                                                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Left" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            ...
                                                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                                                            <HeaderStyle HorizontalAlign="Right" />
                                                                                                                                                                            <ItemStyle ForeColor="Orange" HorizontalAlign="Right" Font-Bold="False" />
                                                                                                                                                                            </asp:BoundField>
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:TextBox ID="TextBox7" runat="server" HeaderText="SUPP_QTY"  BackColor="#244242" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CssClass="BUTTOMNUMBER" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="38px" placeholder="" Width="100px"></asp:TextBox>
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                        <%--                                     <asp:TemplateField>
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button ID="Button40" runat="server" BackColor="Gray" BorderStyle="None" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="40px"  onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='Orange'" Text="View" Width="110px" OnClick="Button40_Click1" />
                                                                                                </ItemTemplate>
                                                                                                <HeaderStyle  ForeColor="Navy" />
                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Right" />
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center">
                                                                                                                                                                    ...
                                                                                                                                                                    <asp:GridView ID="gvInformation6" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#666666" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataSourceID="ProductsBralirwa" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="None" style="margin-left: 0px" Width="100%" DataKeyNames="idProduct">
                                                                                                                                                                        <Columns>
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:CheckBox ID="CheckBox5" runat="server"  CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle ForeColor="Navy" />
                                                                                                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Left" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            ...
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:TextBox ID="TextBox8" runat="server" BackColor="#244242" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CssClass="BUTTOMNUMBER" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="38px" placeholder="" Width="100px"></asp:TextBox>
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                               <%--              <asp:TemplateField>
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button ID="Button40" runat="server" BackColor="Gray" BorderStyle="None" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="40px"  onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='Orange'" Text="View" Width="110px" OnClick="Button40_Click" />
                                                                                                </ItemTemplate>
                                                                                                <HeaderStyle  ForeColor="Navy" />
                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Right" />
                                                                                            </asp:TemplateField>--%>
                                                                                                                                                                ...
                                                                                                                                                                <td align="center">
                                                                                                                                                                    <asp:GridView ID="gvInformation12" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#666666" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataKeyNames="idProduct" DataSourceID="ProductsBralirwa0" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="None" style="margin-left: 0px" Width="100%">
                                                                                                                                                                        <Columns>
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:CheckBox ID="CheckBox19" runat="server" CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle ForeColor="Navy" />
                                                                                                                                                                                <ItemStyle CssClass="input" HorizontalAlign="Left" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            ...
                                                                                                                                                                            <FooterStyle ForeColor="#006666" Width="10px" />
                                                                                                                                                                            <HeaderStyle Width="10px" Wrap="True" />
                                                                                                                                                                            <ItemStyle Font-Size="XX-Small" ForeColor="#333333" HorizontalAlign="Center" Width="10px" />
                                                                                                                                                                            </asp:BoundField>
                                                                                                                                                                            <asp:BoundField DataField="productName" HeaderText="PRODUCT" SortExpression="productName">
                                                                                                                                                                            <ControlStyle Width="300px" />
                                                                                                                                                                            <HeaderStyle HorizontalAlign="Left" Width="300px" Wrap="True" />
                                                                                                                                                                            ...
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:TextBox ID="TextBox71" runat="server" BackColor="#244242" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CssClass="BUTTOMNUMBER" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="38px" placeholder="" Width="100px"></asp:TextBox>
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            <%--   <asp:TemplateField>
                                                                                                <ItemTemplate>
                                                                                                    <asp:Button ID="Button40" runat="server" BackColor="Gray" BorderStyle="None" Font-Bold="True" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="White" Height="40px"  onmouseout="this.style.backgroundColor='Gray'" onmouseover="this.style.backgroundColor='Orange'" Text="View" Width="110px" OnClick="Button40_Click2" />
                                                                                                </ItemTemplate>
                                                                                                <HeaderStyle  ForeColor="Navy" />
                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Right" />
                                                                                            </asp:TemplateField>--%>
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center">
                                                                                                                                                                    <asp:Label ID="AlertLabel66" runat="server" CssClass="LABELINCREASE" Font-Bold="False" Font-Names="Tahoma" ForeColor="Orange">Others</asp:Label>
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center">
                                                                                                                                                                    <asp:GridView ID="gvInformation14" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#666666" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataKeyNames="idProduct" DataSourceID="ProductsBralirwa1" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="None" style="margin-left: 0px" Width="100%">
                                                                                                                                                                        <Columns>
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:CheckBox ID="CheckBox20" runat="server" CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle ForeColor="Navy" />
                                                                                                                                                                                <ItemStyle CssClass="input" HorizontalAlign="Left" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            ...
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:TextBox ID="TextBox75" runat="server" BackColor="#244242" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CssClass="BUTTOMNUMBER" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="38px" placeholder="" Width="100px"></asp:TextBox>
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                ...
                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Right" />
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="center">
                                                                                                                                                                    <asp:Label ID="AlertLabel67" runat="server" CssClass="LABELINCREASE" Font-Bold="False" Font-Names="Tahoma" ForeColor="Orange" Visible="False">Purchases</asp:Label>
                                                                                                                                                                </td>
                                                                                                                                                            </tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td>
                                                                                                                                                                    <asp:GridView ID="gvInformation15" runat="server" AutoGenerateColumns="False" BackColor="DarkSlateGray" BorderColor="#666666" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" DataKeyNames="idProduct" DataSourceID="ProductsBralirwa2" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="None" style="margin-left: 0px" Width="100%" Visible="False">
                                                                                                                                                                        <Columns>
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:CheckBox ID="CheckBox21" runat="server" CausesValidation="True" CssClass="ChkBoxClassok2" Font-Bold="True" Font-Names="Times New Roman" ForeColor="Navy" Height="40px" onclick="javascript:colorchange(this);" style="font-size: xx-large; margin: 0px;" Width="40px" />
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle ForeColor="Navy" />
                                                                                                                                                                                <ItemStyle CssClass="input" HorizontalAlign="Left" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            ...
                                                                                                                                                                            <asp:TemplateField>
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:TextBox ID="TextBox76" runat="server" BackColor="#244242" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CssClass="BUTTOMNUMBER" Font-Bold="True" Font-Names="Times New Roman" Font-Size="XX-Large" ForeColor="White" Height="38px" placeholder="" Width="100px"></asp:TextBox>
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                                                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                                                                                                                            </asp:TemplateField>
                                                                                                ...
                                                                                                <ItemStyle  CssClass="input" HorizontalAlign="Right" />
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="center">
                                                                                                                                                    <asp:SqlDataSource ID="ProductsBralirwa" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [idProduct], [productName] ,quantityStock, PriceSales,PricePurchase,idDrinkCategory FROM [BarProducts] WHERE ([idDrinkCategory] = @idDrinkCategory) ORDER BY productName">
                                                                                                                                                        <SelectParameters>
                                                                                                                                                            <asp:Parameter DefaultValue="2" Name="idDrinkCategory" Type="Int32" />
                                                                                                                                                        </SelectParameters>
                                                                                                                                                    </asp:SqlDataSource>
                                                                                                                                                    ...
                                                                                                                                                    <asp:SqlDataSource ID="ProductsBralirwa2" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [idProduct], [productName] ,quantityStock, PriceSales,PricePurchase,idDrinkCategory FROM [BarProducts] WHERE ([idDrinkCategory] = @idDrinkCategory) ORDER BY productName">
                                                                                                                                                        <SelectParameters>
                                                                                                                                                            <asp:Parameter DefaultValue="5" Name="idDrinkCategory" Type="Int32" />
                                                                                                                                                        </SelectParameters>
                                                                                                                                                    </asp:SqlDataSource>
                                                                                                                                                    ...
                                                                                                                                                    <asp:TextBox ID="TextBox73" runat="server" Visible="False"></asp:TextBox>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td>
                                                                                                                                    <asp:GridView ID="gvInformation9" runat="server" AutoGenerateColumns="False" BackColor="#006666" BorderColor="Gray" BorderStyle="Solid" BorderWidth="0px" CellPadding="4" EnableModelValidation="True" Font-Bold="False" Font-Names="Times New Roman" Font-Size="X-Large" ForeColor="Black" GridLines="Horizontal" style="margin-left: 0px" Width="100%" Visible="False">
                                                                                                                                        <Columns>                                                                                                                           
                                                                                                                                            ...
                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Left" Width="500px" />
                                                                                                                                            </asp:BoundField>                                                                                                                                           
                                                                                                                                            <asp:BoundField DataField="quantity" HeaderText="QUANTITY" SortExpression="quantity">
                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                            <ControlStyle Font-Size="Large" Width="250px" />
                                                                                                                                            <HeaderStyle HorizontalAlign="Left" Width="250px" Wrap="True" />
                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Center" Width="250px" Wrap="True" />
                                                                                                                                            </asp:BoundField>
                                                                                                                                             <asp:BoundField DataField="Price" HeaderText="PRICE-A" SortExpression="Price">
                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                            <ControlStyle Font-Size="Large" Width="250px" />
                                                                                                                                            <HeaderStyle HorizontalAlign="Center" Width="250px" Wrap="True" />
                                                                                                                                            <ItemStyle Font-Bold="False" HorizontalAlign="Center" Width="250px" Wrap="True" />
                                                                                                                                            </asp:BoundField>
                                                                                                                                            <asp:BoundField DataField="Total" HeaderText="TOTAL" SortExpression="Total">
                                                                                                                                            <FooterStyle ForeColor="#244242" />
                                                                                                                                           ...
                                                                                                                                           <asp:TemplateField>
                                                                                                                <ItemTemplate>
                                                                                                                    <asp:CheckBox ID="CheckBox18" runat="server" AutoPostBack="True" BackColor="red" Font-Bold="False" ForeColor="White" Height="40px" OnCheckedChanged="CheckBox18_CheckedChanged" Text="Cancel" Width="140px" />
                                                                                                                </ItemTemplate>
                                                                                                                <FooterStyle BackColor="#006666" />
                                                                                                                <HeaderStyle BackColor="#006666" />
                                                                                                                <ItemStyle BackColor="#006666" Font-Bold="False" HorizontalAlign="Center" />
                                                                                                            </asp:TemplateField>
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    <asp:Panel ID="Panel63" runat="server" BackColor="Gray" CssClass="PanelHomeLogin">
                                                                                                        <table class="auto-style122">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <asp:Panel ID="Panel65" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
...
">
                                                                        ...
                                                                        <td>
                                                                            <asp:Panel ID="Panel71" runat="server" BackColor="#006666">
                                                                                <table class="auto-style339">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <asp:Panel ID="Panel49" runat="server" BackColor="Gray" CssClass="BUTTOM" Height="100%">
                                                                                                <table class="auto-style26">
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <table class="auto-style26">
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="PanelChangePrice" runat="server" BackColor="Gray" CssClass="PanelHomeLogin" Visible="False">
                                                                <table class="auto-style213">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel61" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="AddNewStaff" runat="server" BackColor="Gray" CssClass="PanelHomeLogin" Visible="False" Width="850px">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="Panel72" runat="server" BackColor="#006666">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                                                                <tr>
                                                                                                    <td style="font-weight: 700" valign="top">
                                                                                                        <table class="auto-style213">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="auto-style274" valign="top">
                                                                                                                    <asp:Panel ID="ServiceDervery1" runat="server" BackColor="#006666" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px">
                                                                                                                        <table class="auto-style4">
                                                                                                                            <tr>
                                                                                                                                <td style="text-align: left">
                                                                                                                                    <asp:TextBox ID="TextBox56" runat="server" BackColor="#CCCCCC" BorderStyle="Solid" CssClass="BUTTOM" ForeColor="Navy" Height="16px" placeholder="Staff Name" Width="100%"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td style="text-align: left">
                                                                                                                                    <asp:TextBox ID="TextBox49" runat="server" BackColor="#CCCCCC" BorderStyle="Solid" CssClass="BUTTOM" ForeColor="Navy" Height="16px" placeholder="Contact" Width="100%"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td style="text-align: left">
                                                                                                                                    <asp:TextBox ID="TextBox50" runat="server" BackColor="#CCCCCC" BorderStyle="Solid" CssClass="BUTTOM" ForeColor="Navy" Height="16px" placeholder="NID" Width="100%"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td style="text-align: left">
                                                                                                                                    <asp:TextBox ID="TextBox61" runat="server" BackColor="#CCCCCC" BorderStyle="Solid" CssClass="BUTTOM" ForeColor="Navy" Height="16px" placeholder="CODE" Width="100%"></asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td style="text-align: left">&nbsp;</td>
                                                                                                                                ...
                                                                                                                                <td style="text-align: left">
                                                                                                                                    <asp:Panel ID="Panel76" runat="server" BackColor="Gray">
                                                                                                                                        <table class="auto-style339">
                                                                                                                                            <tr>
                                                                                                                                                <td>
                                                                                                                                                    <asp:Button ID="Button54" runat="server" BackColor="Orange" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="Navy" Height="49px" OnClick="Button54_Click" OnClientClick="return confirm ('Are you sure you want to SUBMIT ?');" onmouseout="this.style.backgroundColor='Orange'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="SUBMIT" Width="108px" />
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                                    <asp:Button ID="Button55" runat="server" BackColor="Orange" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="Navy" Height="49px" OnClick="Button55_Click" OnClientClick="return confirm ('Are you sure you want to UPDATE ?');" onmouseout="this.style.backgroundColor='Orange'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="UPDATE" Width="121px" />
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                                    <asp:Button ID="Button66" runat="server" BackColor="#33CCFF" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="Navy" Height="49px" OnClick="Button66_Click" OnClientClick="return confirm ('Are you sure you want to ACTIVATE ?');" onmouseout="this.style.backgroundColor='#33CCFF'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="ACTIVE" Width="121px" />
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                                    <asp:Button ID="Button65" runat="server" BackColor="#009933" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="White" Height="49px" OnClick="Button65_Click" OnClientClick="return confirm ('Are you sure you want to DESACTIVATE ?');" onmouseout="this.style.backgroundColor='#009933'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="DESACTIVE" Width="121px" />
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                                    <asp:Button ID="Button64" runat="server" BackColor="Red" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="White" Height="49px" OnClick="Button64_Click" OnClientClick="return confirm ('Are you sure you want to DELETE ?');" onmouseout="this.style.backgroundColor='Red'" onmouseover="this.style.backgroundColor='SandyBrown'" Text="DELETE" Width="121px" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                        </table>
                                                                                                                                    </asp:Panel>
                                                                                                                ...
                                                                                                                <td class="auto-style274" colspan="2" valign="top">
                                                                                                                    <asp:Panel ID="ServiceDervery2" runat="server" BackColor="Gray">
                                                                                                                        <table class="auto-style4">
                                                                                                                            <tr>
                                                                                                                                <td style="text-align: left">
                                                                                                                                    <asp:SqlDataSource ID="StaffList" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT [StaffName], [IDStaff], [phone], [NID], [code], [status], [decisionM] FROM [MStaffOperator] ORDER BY [StaffName]"></asp:SqlDataSource>
                                                                                                                                    <asp:Panel ID="Panel93" runat="server" BackColor="SandyBrown" CssClass="BUTTOM0" Width="222px">
                                                                                                                                        <table class="auto-style4">
                                                                                                                                            <tr>
                                                                                                                                                <td>
                                                                                                                                                    <asp:TextBox ID="TextBox62" runat="server" BackColor="White" BorderStyle="None" ForeColor="Navy" Height="26px" placeholder="Staff Name ...." Width="132px"></asp:TextBox>
                                                                                                                                                </td>
                                                                                                                                                <td>
                                                                                                                                                    <asp:Button ID="Button67" runat="server" BackColor="SandyBrown" BorderStyle="None" CssClass="BUTTOM" Font-Bold="True" ForeColor="White" Height="32px" OnClick="Button67_Click" onmouseout="this.style.backgroundColor='SandyBrown'" onmouseover="this.style.backgroundColor='Orange'" Text="Search" Width="69px" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                        </table>
                                                                                                                                    </asp:Panel>
                                                                                                                                    <asp:GridView ID="gvInformation2" runat="server" AutoGenerateColumns="False" CellPadding="8" EnableModelValidation="True" Font-Bold="True" Font-Names="Tahoma" ForeColor="#333333" GridLines="None" style="margin-left: 0px" Width="788px" OnRowDataBound="gvInformation2_RowDataBound">
                                                                                                                                        <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                                                        <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                                                                        <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                                                                        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                                                                                                        <HeaderStyle BackColor="Orange" Font-Bold="True" ForeColor="Gray" />
                                                                                                                                        <EditRowStyle BackColor="#999999" />
                                                                                                                                        <AlternatingRowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                                                                        <Columns>
                                                                                                                                            <asp:BoundField DataField="IDStaff" SortExpression="IDStaff" >
                                                                                                                                            <ItemStyle BackColor="#006666" ForeColor="#006666" />
                                                                                                                                            </asp:BoundField>
                                                                                                                                            <asp:TemplateField>
                                                                                                                                                <ItemTemplate>
                                                                                                                                            ...
                                                                                                                                            <asp:BoundField DataField="decisionM" HeaderText="Status" SortExpression="decisionM" />
                                                                                                                                        </Columns>
                                                                                                                                    </asp:GridView>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Panel ID="AddUserNew" runat="server" BackColor="Gray" CssClass="PanelHomeLogin" Visible="False" Width="923px">
                                                                <table class="auto-style213">
                                                                    <tr>
                                                                        <td class="auto-style354">
                                                                            <asp:Panel ID="Panel74" runat="server" BackColor="#006666" CssClass="BUTTOM" Height="100%">
                                                                                <table class="auto-style26">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table class="auto-style26">
                                                            ...
                                                            <table class="auto-style339">
                                                                ...
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:Panel ID="Panel7" runat="server" BackColor="Gray" CssClass="BUTTOM" Visible="False" Height="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:Panel ID="PanelDelete" runat="server" BackColor="Gray" CssClass="BUTTOM" Visible="False" Height="100%">
                                                                <table class="auto-style339">
                                                                    <tr>
                                                                        <td>
                                                                                ...
                                                                                <table class="auto-style339">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <asp:TextBox ID="TextBox60" runat="server" Visible="False" Width="35px"></asp:TextBox>
                                                                                        </td>
                                                                                        <td style="text-align: right">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:GridView ID="gvServed" runat="server" AutoGenerateColumns="False" CellPadding="8" DataSourceID="SqlDataSource8" EnableModelValidation="True" ForeColor="#333333" GridLines="None" Width="857px">
                                                                                <RowStyle BackColor="#006666" Font-Bold="True" ForeColor="White" />
                                                                                <FooterStyle BackColor="Orange" Font-Bold="True" ForeColor="White" />
                                                                                <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                                                <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                        ...
                        <tr>
                            <td class="auto-style210" colspan="3">
                                &nbsp;</td>
                        </tr>
                        <tr>
                            <td class="auto-style210">
                                ...
                                <asp:SqlDataSource ID="StaffDailyTOTAL" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM([amount]) AS amount  FROM [StaffCreditReports1] where ([OperationDay] = @OperationDay) AND NameCredit ='Credit'">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                ...
                                <asp:SqlDataSource ID="StaffDailyPAYMENT" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM([Payment]) AS Payment FROM [StaffCreditReports1] where ([OperationDay] = @OperationDay)  AND NameCredit ='Credit'">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            ...
                            <td class="auto-style211">
                                ...
                                <asp:SqlDataSource ID="SqlDataTOTAL" runat="server" ConnectionString="<%$ ConnectionStrings:SmartAdiminConnectionString %>" SelectCommand="SELECT SUM(Price) AS Price, SUM(PayedCash) AS PayedCash FROM WebDetailsDataView WHERE (OperationDay = @OperationDay) AND (Payment &lt;&gt; 'Credit')">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="DropDownList14" Name="OperationDay" PropertyName="SelectedValue" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
