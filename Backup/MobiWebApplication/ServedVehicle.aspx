<%@ Page Language="C#" MasterPageFile="~/Mobi.Master" AutoEventWireup="true" CodeBehind="ServedVehicle.aspx.cs" Inherits="MobiWebApplication.WebForm4" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <table class="style1">
        <tr>
            ...
            <asp:Label ID="Label2" runat="server" CssClass="style11" Font-Bold="True"
                ...
                style="text-align: center" Text="SERVICE PAYMENT" Width="341px"></asp:Label>
                             </td>
            <td class="style87">
                </td>
            <td class="style88">
        ...
        <tr>
            ...
            <td class="style13" colspan="2">
                <asp:TextBox ID="TextBox3" runat="server" BorderStyle="Groove" ForeColor="Navy" 
                    Height="30px" ontextchanged="TextBox3_TextChanged" Width="359px" 
                    BorderColor="#000066" BorderWidth="1px"></asp:TextBox>
            </td>
            <td class="style76">
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="style7">
                <asp:Button ID="Button2" runat="server" 
                    ...
                    Width="150px" BorderWidth="1px" Font-Bold="True"/>
            </td>
            <td class="style75">
                <asp:Button ID="Button1" runat="server" 
                    ...
                    Text="Save" Width="187px" BorderWidth="1px" Font-Bold="True"/>
            </td>
            <td class="style8">
                <asp:Button ID="Button10" runat="server" Height="39px" Text="Go to Edit" 
                    Width="163px"  onmouseover="this.style.backgroundColor='DodgerBlue'" ForeColor="White" 
            ...
            <td class="style78">
                <asp:Button ID="Button11" runat="server" Height="39px" 
                    onclick="Button11_Click1" Text="View Reports" Width="148px" 
                     onmouseover="this.style.backgroundColor='DodgerBlue'" ForeColor="White" 
                    onmouseout="this.style.backgroundColor='#4CAF50'" BackColor="#00CC66"  BorderWidth="1px" Font-Bold="True"/>
            </td>
            <td class="style31">
                </td>
        </tr>
    ...
    <asp:GridView ID="gvServed" runat="server" CellPadding="8" 
